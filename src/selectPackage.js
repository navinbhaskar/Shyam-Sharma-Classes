...
class buynow extends Component {
  ...
  async componentDidMount() {
    ...
    if(this.props.navigation.state.params.data.books_available) {
      new_packages = [{
        'amount': this.props.navigation.state.params.data.amount_course_plus_books,
        'name': this.props.navigation.state.params.data.course_name + ' plus books',
        'details': this.props.navigation.state.params.data.details,
        'selected': false
      },{
        'amount': this.props.navigation.state.params.data.amount_only_books,
        'name': this.props.navigation.state.params.data.course_name + ' only books',
        'details': this.props.navigation.state.params.data.details,
        'selected': false
      }]
      this.setState({ package: [...this.state.package, ...new_packages] })
    }
    ...
    return (
        <View style={{width: '100%', height: '100%'}}>
        	...
        	<TouchableNativeFeedback
        		onPress={() => {
				  var options = {
				    description: "Shyam Sharma's Classes",
				    image: 'https://storage.googleapis.com/shyam_sharmas_classes_delhi/ic_launcher.png',
				    currency: 'INR',
				    key: 'rzp_live_JaendC6mC2OhPf',
